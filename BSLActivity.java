	...
	private void init() {
		...
		listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if(nodeinfo.getType()==0x13||nodeinfo.getType()==0x14||nodeinfo.getType()==0x0b||nodeinfo.getType()==0x11)
				{

					Intent intent=new Intent();
					if(nodeinfo.getType()==0x14)
					{
						ControlInterface.currentUiName="声音";
					}
					else if(nodeinfo.getType()==0x13)
					{
						ControlInterface.currentUiName="灯光控制";
					}
					else if(nodeinfo.getType()==0x0b)
					{
						ControlInterface.currentUiName="温度湿度控制";
					}
					else
					{
						ControlInterface.currentUiName="振动控制";
					}
		...
		Integer[] images = { R.drawable.room_gallery_0};
		/*, R.drawable.room_gallery_1,
	...
	private void init() {
		...
		listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if(nodeinfo.getType()==0x17||nodeinfo.getType()==0x11||nodeinfo.getType()==0x0b||nodeinfo.getType()==0x11)
				{

					Intent intent=new Intent();
					if(nodeinfo.getType()==0x11)
					{
						ControlInterface.currentUiName="声音";
					}
					else if(nodeinfo.getType()==0x17)
					{
						ControlInterface.currentUiName="灯光控制";
					}
					else if(nodeinfo.getType()==0x0b)
